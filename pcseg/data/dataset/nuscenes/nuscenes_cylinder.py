...
class NuscCylinderDataset(data.Dataset):
    def __init__(
        self,
        data_cfgs = None,
        training = True,
        ...
        self.logger = logger
        self.use_scene_flow = self.data_cfgs.USE_SCENE_FLOW
        self.class_names = ['noise', 'barrier', 'bicycle', 'bus', 'car', 'construction_vehicle', 'motorcycle',
        ...
        self.point_cloud_dataset = NuscenesDataset(
            ...
            logger=logger,
            use_scene_flow=self.use_scene_flow
        )
    ...
    def get_single_sample(self, index, voting_idx=0):
        ...
        voxel_coord, voxel_label, inds, inverse_map = voxelize_with_label(
            point_coord, point_label, 17)   # 一共17类（第0类是ignore）
